...
type AdminUsecase interface {
	...
	CreateAdmin(ctx context.Context, user *entitie.AdminReq, userID *int) (int64, error)
	UpdateAdmin(ctx context.Context, adminID int, userID int, user *entitie.AdminReq) error
